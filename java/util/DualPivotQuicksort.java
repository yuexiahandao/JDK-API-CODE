 ...
 * @since 1.7
 *
 * 顺序连续性不好的数组直接使用了 双轴快排 + 成对插入排序。成对插入排序是插入排序的改进版，它采用了同时插入两个元素的方式调高效率。
 * 双轴快排是从传统的单轴快排到3-way快排演化过来的，网上之前已经有很多博客介绍这种算法。这里推荐 国外一篇文章，
 * 它的3张图和下面的代码帮助我理解了快排，3-way和双轴快排之间的关系。
 *
 * 参考： https://www.jianshu.com/p/6d26d525bb96
 */
